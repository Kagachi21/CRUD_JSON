...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.html">Weeboo</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/Tsumugi 2.png')">
      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form action="contact.php" method="POST">
          ...
          <div class="form-group">
            <button type="submit" name="add" class="btn btn-primary" id="sendMessageButton">Send</button>
          </div>
        </form>
        <div class="form-group">
            <button onclick="window.location.href='list.php'" class="btn btn-primary" id="sendMessageButton">List Contact</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <?php
if (isset($_POST["add"])) {
    $file = file_get_contents('contact.json');
    $data = json_decode($file, true);
    unset($_POST["add"]);
    $data["Call"] = array_values($data["Call"]);
    array_push($data["Call"], $_POST);
